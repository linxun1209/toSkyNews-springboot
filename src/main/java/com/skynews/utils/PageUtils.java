...
public class PageUtils {
    @ApiModelProperty(value="开始数据的索引")
    int start;  //开始数据的索引
     ...
     * 判断是否有上一页
     */
    @ApiModelProperty(value = "判断是否有上一页")
    ...
    @ApiModelProperty(value = "判断是否有下一页")
     ...
     * 计算得到的总页数
     */
    @ApiModelProperty(value = "计算得到的总页数")
     ...
     * 计算尾页的第一条数据索引
     */
    @ApiModelProperty(value = "计算尾页的第一条数据索引")
    public int getLast(){
